...
public class RepeatAllWordsCommand extends IdHandler implements Command {
    ...
    final private Logger log = Logger.getLogger(com.bot.engBot.commands.AddWordCommand.class);
    ...
    public void execute(Update update) {
        ...
        vocabularyService.retrieveAllUserWord(senderId).forEach(this::resetRepeats);
